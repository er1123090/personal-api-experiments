...
# 1. 스크립트 및 데이터 경로 설정
# ==============================================================================
PYTHON_SCRIPT="/data/minseo/personal-tool/conv_api/experiments3/vanillaLLM/vanillaLLM_inference-api-async.py"
...
# 기본 출력/로그 디렉토리
BASE_OUTPUT_DIR="/data/minseo/personal-tool/conv_api/experiments3/vanillaLLM/inference/output2"
BASE_LOG_DIR="/data/minseo/personal-tool/conv_api/experiments3/vanillaLLM/inference/logs2"
